#
#  Be sure to run `pod spec lint BBNestScrollView.podspec.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "fish" => "yuchuanxing@zto.com" }
  # Or just: spec.author    = "fish"
  # spec.authors            = { "fish" => "yuchuanxing@zto.com" }
  # spec.social_media_url   = "https://twitter.com/fish"
